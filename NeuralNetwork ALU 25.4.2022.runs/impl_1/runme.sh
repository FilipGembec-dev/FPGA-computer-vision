...
HD_PWD='C:/Users/Filip/Documents/Xilinix projects/NeuralNetwork ALU 25.4.2022/NeuralNetwork ALU 25.4.2022.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ModularNeuralNet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ModularNeuralNet.tcl -notrace
