...
HD_PWD='C:/Users/Filip/Documents/Xilinix projects/NeuralNetwork ALU 25.4.2022/NeuralNetwork ALU 25.4.2022.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModularNeuralNet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModularNeuralNet.tcl
